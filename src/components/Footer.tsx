      ...
      <div className="max-w-7xl mx-auto px-6 space-y-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 pb-8 border-b border-navy/5">
          ...
          <Link href="/" className="order-1 md:order-2">
            <span className="text-2xl font-heading font-bold text-navy tracking-tight">THE VISTA</span>
          </Link>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 text-sm">
          {/* TAGLINE */}
          <p className="text-muted font-medium order-3 lg:order-1">{t('footerTagline')}</p>
          ...
          {/* COPYRIGHT */}
          <div className="text-muted font-medium order-2 lg:order-3">
            {t('footerCopyright')}
          </div>
        </div>
      </div>
