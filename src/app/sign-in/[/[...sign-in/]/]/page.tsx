  ...
  return (
    <div className="min-h-screen bg-v-background flex items-center justify-center p-6 py-32">
      <div className="absolute inset-0 z-0 opacity-40 pointer-events-none">
        ...
        <div className="absolute bottom-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full bg-navy/5 blur-[120px]" />
      </div>

      <div className="relative z-10 w-full max-w-md animate-in fade-in zoom-in duration-500">
        <div className="text-center mb-10">
          <h1 className="text-4xl font-heading font-bold text-navy mb-3 tracking-tight">THE VISTA</h1>
          <p className="text-muted text-sm font-medium uppercase tracking-[0.2em]">Exquisite Guest Access</p>
        </div>
