...
export async function POST(req: Request) {
  try {
    ...
    const redirectionUrl = `${baseUrl}/api/payments/paymob/callback?bookingId=${booking.id}&propertyId=${propertyId}&from=${checkIn}&to=${checkOut}&adults=${adults}&children=${children}&email=${encodeURIComponent(guestEmail)}`;
